...
![](Water-data-workflow.png){fig-align="center"}
...
![**Figure 1:** Water Temperature Over Time. Date is on the x-axis and Temperature is on the y-axis. The red dashed line shows the reduced capacity threshold of 85 degrees Fahrenheit (29 degrees Celsius).](WaterTempOverTimeLineChart.png)
...
![](DemandOverTime.png){fig-alt="Figure 2: Electricity Demand Over Time. Timestamp is on the x-axis and Demand is on the y-axis." fig-align="center" width="550"}
