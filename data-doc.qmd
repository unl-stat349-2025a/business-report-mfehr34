...
There are three data sets that have the exact same data and structure that were combined to analyze the trends of water temperature. These data sets are separated by year, from the years 2022, 2023, and 2024. Data was collected every thirty minutes (sometimes every six minutes), every day of the year, and recorded as a new instance. The data starts in January 2022 and ends in December 2024.
